...
#define not_tested() not_tested_message(MM_FUNC_NAME)
#define not_implemented() not_implemented_message(MM_FUNC_NAME)
#define subclass_responsibility() not_implemented_message(MM_FUNC_NAME)
